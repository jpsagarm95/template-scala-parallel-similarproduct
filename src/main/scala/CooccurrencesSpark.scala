...
import com.google.common.collect.{BiMap => GMap}
import org.apache.mahout.math.indexeddataset.IndexedDataset
...
//start
  ...
  val itemStringtoInt : GMap[String, Int]
//stop	
...
/**
  * Use COS to build item x feature matrix
  */
class COSAlgorithm(val ap: COSAlgorithmParams)
  ...
  def train(sc: SparkContext, data: PreparedData): COSModel = {
    ...
    // MLLib COS cannot handle empty training data.
